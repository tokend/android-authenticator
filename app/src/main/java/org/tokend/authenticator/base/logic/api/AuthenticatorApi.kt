...
import org.tokend.authenticator.base.logic.api.authresult.AuthResultApi
import org.tokend.authenticator.base.logic.api.authresult.AuthResultService
...
class AuthenticatorApi(
    ...
    val authResult: AuthResultApi by lazy {
        AuthResultApi(getService(AuthResultService::class.java))
    }
